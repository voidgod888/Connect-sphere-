<div align="center">
<img width="1200" height="475" alt="ConnectSphere Banner" src="https://github.com/user-attachments/assets/0aa67016-6eaf-458a-adb2-6e31a0763ed6" />
...
[🚀 Quick Start](#-quick-start) • [✨ Features](#-features) • [📖 Documentation](#-documentation) • [🛠️ API Reference](#-api-reference)
...
- 🗣️ Practicing foreign languages with native speakers  
...
- ⏱️ Total time spent chatting
- 🌍 Countries connected (with list)
- 🔥 Current & longest streaks
- ⭐ Average rating (1-5 stars)
- 🏅 Global rank position

**Achievement System**
Unlock 8 built-in achievements:
- 🎉 First Contact - Complete first chat
...
- ⭐ Star ratings for top performers
- 🎯 Track your rank progress
- 🔄 Real-time rank updates

**More Achievements**
- ⏱️ Marathon Chatter - 1-hour chat
- 🦋 Social Butterfly - 100 chats
...
<tr>
<th width="33%">🆓 Free</th>
<th width="33%">💎 Premium ($4.99/mo)</th>
<th width="33%">👑 VIP ($9.99/mo)</th>
</tr>
<tr>
<td>

✅ Basic matching<br>
✅ Standard video quality<br>
✅ Text chat<br>
✅ Basic filters<br>
✅ 5 themes<br>
⚠️ 5 skips/hour<br>
...
- 💰 Earn coins through daily logins and achievements
- 🛒 Purchase coin packages ($0.99 - $14.99)
- 🚀 Spend on profile boosts (100 coins = 24hr boost)
- 🎁 Buy virtual gifts for chat partners
...
**Enhanced Reporting**
6 detailed report categories:
- 🚫 Inappropriate Content (nudity, sexual)
- 😠 Harassment (bullying, threats)
- 📧 Spam (unwanted advertising)
- 👶 Underage User (under 13)
- ⚠️ Violence (threats, dangerous behavior)
...
- 👥 Age-appropriate matching (max 2-3 year gap)
- ⏱️ Session time limits (30-60 min by age)
- 📅 Daily usage limits (2-4 hours by age)
- 🛡️ Enhanced safety guidelines
- 🚨 Priority report review
- 👨‍👩‍👧 Parental controls ready

**Additional Protection**
- 🤬 4-level profanity filter
- ✅ User verification system
- 🔒 Safe mode for verified users only
...
- ✅ **Camera & Microphone** (for video chat)
...
### 5️⃣ (Optional) Android Termux Setup
...
└── 📚 Documentation
    ...
    └── TEEN_SAFETY.md       # Safety features guide
```
...
components/
├── 🎯 Matching & Discovery
│   ├── InterestSelector.tsx       # Interest tag selection
│   ├── LanguageSelector.tsx       # Language preferences
│   └── QueueStatsDisplay.tsx      # Queue statistics
│
├── 🏆 Gamification
│   ├── StatsPanel.tsx             # User statistics dashboard
│   ├── AchievementBadge.tsx       # Achievement display
│   └── LeaderboardPanel.tsx       # Global leaderboard
│
├── 🎨 User Experience
│   ├── ThemeSelector.tsx          # Theme switcher
│   ├── AdvancedSettingsPanel.tsx  # Advanced settings
│   ├── KeyboardShortcutsPanel.tsx # Keyboard shortcuts
│   └── Toast.tsx                  # Toast notifications
│
├── 💎 Premium
│   └── PremiumModal.tsx           # Subscription management
│
├── 🛡️ Security
│   ├── EnhancedReportModal.tsx    # User reporting
│   ├── TeenSafetyMode.tsx         # Teen safety features
│   └── AgeVerification.tsx        # Age verification
│
├── ⚡ Performance
│   ├── ConnectionQualityIndicator.tsx  # Quality monitoring
│   ├── BandwidthSaverMode.tsx          # Data optimization
│   └── NetworkDiagnostics.tsx          # Network testing
│
└── 💬 Chat
...
- **[📋 Complete Feature List](./FEATURES_ADDED.md)** - Detailed documentation of all 50+ features
- **[🚀 Quick Start Guide](./QUICK_START.md)** - Integration examples and usage patterns
- **[🛡️ Teen Safety Guide](./TEEN_SAFETY.md)** - Age 13+ safety features and parental controls
- **[🔗 Integration Example](./INTEGRATION_EXAMPLE.tsx)** - Code examples for developers
- **[📊 Age 13+ Summary](./AGE_13_PLUS_SUMMARY.md)** - Summary of teen safety features

### 🎓 Learning Resources

**Getting Started:**
1. Read this README to understand the architecture
2. Check [QUICK_START.md](./QUICK_START.md) for integration examples
3. Review [FEATURES_ADDED.md](./FEATURES_ADDED.md) for detailed feature documentation
...
- ✔️ **Rate Limiting** - Prevents API abuse (100 req/15min per IP)
- ✔️ **JWT Authentication** - Secure session tokens
- ✔️ **CORS Protection** - Configurable allowed origins
- ✔️ **Input Validation** - Server-side validation on all inputs
- ✔️ **SQL Injection Protection** - Parameterized queries only
- ✔️ **XSS Protection** - Content sanitization
- ✔️ **HTTPS Ready** - Designed for secure deployment
- ✔️ **Teen Safety** - Age-appropriate protections and time limits
...
- ✅ Check browser permissions - grant camera/microphone access
- ✅ Verify devices aren't being used by another application
- ✅ Try a different browser (Chrome recommended)
- ✅ Check device drivers are up to date
- ✅ Test on https://www.webrtc-experiment.com/DetectRTC/
...
**Solutions:**
- ✅ Ensure `server/data/` directory exists (create if missing)
- ✅ Check file permissions on database file
- ✅ Verify SQLite is properly installed
- ✅ Try deleting database file to reset: `rm server/data/connectsphere.db` ⚠️ **(data loss)**
- ✅ Check database path in `server/.env`
...
- ✅ Look for port conflicts: `lsof -i :3000` or `lsof -i :3001`
- ✅ Try cleaning Vite cache: `rm -rf node_modules/.vite`
...
**Solutions:**
- ✅ Verify Google/Apple OAuth credentials are correct
- ✅ Check OAuth redirect URIs match your domain exactly
- ✅ Ensure `ALLOW_MOCK_AUTH=true` is set for development without OAuth
...
- ✅ Lower video quality in Connection Quality settings
- ✅ Run Network Diagnostics to test your connection
- ✅ Close unnecessary browser tabs and applications
- ✅ Check CPU usage - video processing is intensive
- ✅ Ensure adequate internet bandwidth (min 1 Mbps recommended)
...
- **[Vite Team](https://vitejs.dev/)** - For lightning-fast development experience
...
[⬆ Back to Top](#-connectsphere)

---

**[View Project](https://ai.studio/apps/drive/1ofeiJrs9NpD6RVASf3zfsigHOpHV4ncW)** • **[Report Bug](../../issues)** • **[Request Feature](../../issues)**
